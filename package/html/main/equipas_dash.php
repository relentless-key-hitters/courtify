...
<body>
          ...
          <div class="container mt-5">
            <table class="table" id="tabela">
              ...
              <tbody>
                ...
                <tr class="text-center">
                  <td></td>
                  <td><img src="./../../dist/images/backgrounds/w.png" alt="Thumbnail 1" class="object-fit-cover"
                      width="30" height="30"></td>
                  <td>WPC</td>
                  <td>N2</td>
                  <td><button type="button" class="btn btn-sm btn-light" data-toggle="modal"
                      data-target="#equipaJogoModal">Ver</button></td>
                  <td></td>
                  <td></td>
                </tr>
                ...
                <tr class="text-center">
                  <td></td>
                  <td><img src="./../../dist/images/backgrounds/padelball3.png" alt="Thumbnail 1"
                      class="object-fit-cover" width="30" height="30"></td>
                  <td>PadelBall 3</td>
                  <td>N2</td>
                  <td><button type="button" class="btn btn-sm btn-light" data-toggle="modal"
                      data-target="#equipaJogoModal">Ver</button></td>
                ...
                <tr class="text-center">
                  <td></td>
                  <td><img src="./../../dist/images/backgrounds/30.png" alt="Thumbnail 1" class="object-fit-cover"
                      width="30" height="30"></td>
                  <td>Skeletons</td>
                  <td>N2</td>
                  <td><button type="button" class="btn btn-sm btn-light" data-toggle="modal"
                ...
                <tr class="text-center">
                  <td></td>
                  <td><img src="./../../dist/images/backgrounds/racketman.png" alt="Thumbnail 1"
                      class="object-fit-cover" width="30" height="30"></td>
                  <td>RacketMan</td>
                  <td>N4</td>
                  <td><button type="button" class="btn btn-sm btn-light" data-toggle="modal"
                ...
                <tr class="text-center">
                  <td></td>
                  <td><img src="./../../dist/images/backgrounds/smoothsailors.png" alt="Thumbnail 1"
                      class="object-fit-cover" width="30" height="30"></td>
                  <td>SmoothSailors</td>
                  <td>N4</td>
                  <td><button type="button" class="btn btn-sm btn-light" data-toggle="modal"
          ...
          <div class="row">
            <div class="col-md-7 pt-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nome" placeholder="Digite o nome da equipa">
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-5 pt-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="nome" placeholder="Digite o nº máx de participantes">
              </div>
            </div>
            ...
            <div class="col-md-4 pt-4">
              <div class="form-group">
                ...
                <select name="nivel" class="form-select" id="">
                  ...
                  <option value="n54">N5/N4</option>
                  <option value="n4">N4</option>
                  <option value="n43">N4/N3</option>
                  <option value="n3">N3</option>
                  <option value="n32">N3/N2</option>
                  <option value="n2">N2</option>
                  <option value="n21">N2/N1</option>
  ...
  <div class="modal modal-lg fade" id="equipaJogoModal" tabindex="-1" role="dialog" aria-labelledby="equipaJogoModal"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title fs-7" id="equipaJogoModalLabel">Próximas Jogos</h5>
          <button type="button" class="btn btn-sm" style="background-color: darkgray;" data-dismiss="modal"
            aria-label="Close">
            <span> <i class="ti ti-x text-white"></i></span>
          </button>
