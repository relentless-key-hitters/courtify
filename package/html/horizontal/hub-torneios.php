        ...
        <div class="">
          <div class="row">
            <div class="col-lg-12" style="position: relative; margin-top: 80px;">
              ...
              <img class="img-fluid" src="../../dist/images/backgrounds/torneiosback2.jpg" style="width: 100%; max-width: 100%; height: 600px; object-position: bottom; object-fit: cover; filter: brightness(50%);">
              <div style="position: absolute; top: 50%; transform: translateY(-50%); left: 10%; text-align: center; color: white;">
                ...
                <div class="card-body">
                  <div class="row flex-lg-row-reverse align-items-center g-5 py-3">
                    <div class="col-10 col-sm-8 col-lg-6">
                      <img src="../../dist/images/backgrounds/banner_hub_torneios.jpg" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000" class="img-fluid rounded" alt="Imagem Torneios" width="700" height="500">
                    </div>
                    <div class="col-lg-6">
                      <h1 class="display-5 fw-bold lh-1 mb-2" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">O ponto de encontro para Atletas</h1>
                      <p class="lead mt-5" data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000">Apresentamos-te os nossos torneios. Os torneios são eventos criados pelos Clubes nas diferentes modalidades que os mesmos abrangem. Inscreve-te, conhece atletas e vence! </p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card shadow bg-light px-3 py-3">
                  ...
                  <div class="card shadow">
                    <div class="card-body">
                      ...
                      <ul class="nav nav-pills user-profile-tab justify-content-center bg-light mt-2 rounded-2" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <button class="nav-link position-relative rounded-0 active d-flex align-items-center justify-content-center bg-transparent fs-3" id="pills-padel-tab" data-bs-toggle="pill" data-bs-target="#pills-padel" type="button" role="tab" aria-controls="pills-padel" aria-selected="true">
                            <i class="ti ti-ball-tennis me-2 fs-6"></i>
                            <span class="d-none d-md-block fs-7">Padel</span>
                          </button>
                        </li>
                        <li class="nav-item" role="presentation">
                          <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3" id="pills-tenis-tab" data-bs-toggle="pill" data-bs-target="#pills-tenis" type="button" role="tab" aria-controls="pills-tenis" aria-selected="false">
                            <i class="ti ti-ball-tennis me-2 fs-6"></i>
                            <span class="d-none d-md-block fs-7">Ténis</span>
                          </button>
                        </li>
                        <li class="nav-item" role="presentation">
                          <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3" id="pills-basket-tab" data-bs-toggle="pill" data-bs-target="#pills-basket" type="button" role="tab" aria-controls="pills-basket" aria-selected="false">
                            <i class="ti ti-ball-basketball me-2 fs-6"></i>
                            <span class="d-none d-md-block fs-7">Basquetebol</span>
                          </button>
                        </li>
                        <li class="nav-item" role="presentation">
                          <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3" id="pills-futsal-tab" data-bs-toggle="pill" data-bs-target="#pills-futsal" type="button" role="tab" aria-controls="pills-futsal" aria-selected="false">
