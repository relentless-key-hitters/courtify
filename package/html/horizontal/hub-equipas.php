                ...
                <div class="card-body">
                  <div class="row flex-lg-row-reverse align-items-center g-5 py-3">
                    <div class="col-10 col-sm-8 col-lg-6">
                      <img src="../../dist/images/backgrounds/banner_hub_equipas.jpg" class="img-fluid rounded" alt="Imagem Equipas" width="700" height="500">
                    </div>
                    <div class="col-lg-6">
                      <h1 class="display-5 fw-bold lh-1 mb-2">Descobre as diferentes Equipas que escolhem a Courtify</h1>
                      <p class="lead mt-5">Esta página é o teu ponto de partida para ficares a conhecer Atletas com quem te possas identificar. Junta-te a Equipas e começa a partilhar momentos e experiências.</p>
                    </div>
                  </div>
                </div>
              </div>
