  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="horizontal" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <ul class="navbar-nav">
          <li class="nav-item d-none d-xl-block">
            <a href="#" class="text-nowrap nav-link mb-2">
              <img src="../../../landingpage/dist/images/logos/logo_courtify.png" class="dark-logo" width="180"
                alt="" />
              <img src="../../../landingpage/dist/images/logos/light-logo.svg" class="light-logo" width="180" alt="" />
            </a>
          </li>
          <li class="nav-item mt-1">
            <a class="nav-link nav-icon-hover" href="javascript:void(0)" onclick="getAtletasPesquisaNavbar()"
    ...
    <div class="body-wrapper">
      <div class="overflow-hidden">
        <div id="carouselExampleAutoplaying" class="carousel slide bg-light-primary d-none d-md-block"
          data-bs-ride="carousel" style="width: 100%; margin-top: 80px;">
          <div class="carousel-inner">
            <div class="carousel-item active ">
              <div class="text-white d-flex justify-content-center align-items-center"
                style="height: 700px; overflow: hidden;">
                <img class="card-img" src="../../../landingpage/dist/images/carousel/carousel_img1.jpg" alt="Card image"
                  style="object-fit: cover; object-position: center; height: 100%;">
                <div class="card-img-overlay bg-dark bg-opacity-75 d-flex flex-column align-items-center"
                  style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0.75), transparent);">
                  <img src="../../../landingpage/dist/images/logos/logo_icone.png" alt="Icon"
                    style="position: absolute; top: 20px; right: 20px; width: 50px; height: 50px;">
                  <h1 class="text-white mt-3 mb-3 fs-13 fw-semibold" data-aos="fade-up" data-aos-delay="400"
                    data-aos-duration="1000">
                    Ainda te lembras da tua última partida de <span style="color: #71c449;">Ténis</span>?</h1>
                  <p class="fs-9 mb-5 text-white " data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
                    Combina já a próxima com os teus <span style="color: #71c449;">Amigos</span>!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="carousel-item">
              <div class="bg-dark text-white d-flex align-items-end"
                style="height: 700px; overflow: hidden; position: relative;">
                <img class="card-img" src="../../../landingpage/dist/images/carousel/carousel_img2.jpg" alt="Card image"
                  style="object-fit: cover; height: 100%; opacity: 0.7;">
                <div
                  class="card-img-overlay bg-dark bg-opacity-50 d-flex flex-column align-items-end justify-content-end"
                  style="position: absolute; bottom: 0; right: 0; background: linear-gradient(to top, rgba(0, 0, 0, 0.75), transparent);">
                  <img src="../../../landingpage/dist/images/logos/logo_icone.png" alt="Icon"
                    style="position: absolute; bottom: 20px; left: 20px; width: 50px; height: 50px;">
                  <h1 class="text-white mb-3 me-3 fs-13 fw-semibold" data-aos="fade-up" data-aos-delay="400"
                    data-aos-duration="1000">
            ...
            <div class="carousel-item">
              <div class="bg-dark text-white d-flex justify-content-center align-items-center"
                style="height: 700px; overflow: hidden;">
                <img class="card-img" src="../../../landingpage/dist/images/carousel/carousel_img3.jpg" alt="Card image"
                  style="object-fit: cover; height: 100%;">
                <div
                  class="card-img-overlay bg-dark bg-opacity-50 d-flex flex-column justify-content-center align-items-center">
                  <img src="../../../landingpage/dist/images/logos/logo_icone.png" alt="Icon"
                    style="position: absolute; top: 20px; left: 20px; width: 50px; height: 50px;">
                  <h1 class="text-white mt-3 mb-3 fs-13 fw-semibold" data-aos="fade-up" data-aos-delay="400"
                    data-aos-duration="1000">
      ...
      <section
        class="bg-light hero-section position-relative overflow-hidden pt-2 pt-lg-7 pt-xl-9 pb-8 pb-lg-9 mt-5 mt-md-0">
        <div class="container mt-3 mt-md-0">
          <div class="row align-items-center">
            <div class="col-xl-9">
              <div class="hero-content my-11 my-xl-0">
                <h6 class="d-flex align-items-center gap-2 mb-7" data-aos="fade-up" data-aos-delay="200"
                  data-aos-duration="1000"><small class="text-primary fw-semibold d-block fs-5">PREPARA-TE PARA
      ...
      <section class="pt-lg-7 pt-sm-3" id="visao-courtify">
        <div class="container">
          <div class="container px-4 pt-lg-7 pt-sm-3 text-center" id="featured-3">
            <small class="text-primary fw-semibold mb-2 d-block fs-5" data-aos="fade-up" data-aos-delay="200"
              data-aos-duration="1000">PARA UNIR ATLETAS</small>
            <h2 class="fs-13 text-center mb-4 mb-lg-3 fw-bolder mt-3" data-aos="fade-up" data-aos-delay="400"
              data-aos-duration="1000">A nossa <span class="text-success">Visão</span></h2>
            <div class="row g-4 py-5 row-cols-1 row-cols-lg-3 text-center">
              <div class="feature col">
                <div class="">
                  <img src="../../../landingpage/dist/images/icons/icone_comunidade_blue.png" data-aos="fade-up"
                    data-aos-delay="600" data-aos-duration="1000" class="mb-3" height="64px" width="64px">
                </div>
              ...
              <div class="feature col">
                <div class="">
                  <img src="../../../landingpage/dist/images/icons/icone_progressao_green.png" data-aos="fade-up"
                    data-aos-delay="600" data-aos-duration="1000" class="mb-3" height="64px" width="64px">
                </div>
              ...
              <div class="feature col">
                <div class="">
                  <img src="../../../landingpage/dist/images/icons/icone_desporto_blue.png" data-aos="fade-up"
                    data-aos-delay="600" data-aos-duration="1000" class="mb-3" height="64px" width="64px">
                </div>
      ...
      <section class="features-section bg-light pt-lg-7 pt-sm-3 pb-8 pb-lg-9" id="features-courtify">
        <div class="container">
          <div class="row justify-content-center mt-3">
            <div class="col-lg-10">
              <div class="text-center">
                <small class="text-primary fw-semibold mb-2 d-block fs-5" data-aos="fade-up" data-aos-delay="200"
                  data-aos-duration="1000">UM MUNDO DE POSSIBILIDADES</small>
                <h2 class="fs-13 text-center mb-4 mb-lg-9 fw-bolder mt-3" data-aos="fade-up" data-aos-delay="400"
                  data-aos-duration="1000">Os aspetos <span class="text-primary">Chave</span> da<img
                    src="../../../landingpage/dist/images/logos/logo_courtify.png" width="250px" alt="img-fluid"
                    class="mb-4">
          ...
          <div class="review-slider" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000"
      ...
      <section class="pt-lg-7 pt-sm-3 pb-8 pb-lg-9" id="pacotes-courtify">
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <div class="lc-block mb-4 mt-3">
                <small class="text-primary fw-semibold mb-2 d-block fs-5" data-aos="fade-up" data-aos-delay="200"
                  data-aos-duration="1000">AO ALCANCE DE UM CLIQUE</small>
                <h2 class="fs-13 text-center mb-4 fw-bolder" data-aos="fade-up" data-aos-delay="400"
                  data-aos-duration="1000">É aqui o <span class="text-success">Ponto de Partida</span></h2>
              </div><!-- /lc-block -->
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row mt-2">
            <div class="col-sm-12 mt-2 mt-md-0 col-lg-6" data-aos="fade-right" data-aos-delay="600"
              data-aos-duration="1000">
              <div class="card">
                <div class="card-body text-center">
                  <span class="fw-bolder text-primary fs-8 d-block mb-7">Atleta <h2 class="fw-semibold fs-9 mb-7">
                      Grátis
                    </h2></span>

                  <ul class="list-unstyled mb-7 ps-3 fs-7">
                    ...
                    <li class="d-flex align-items-center gap-2 py-2">
                      <i class="ti ti-check text-primary"></i>
                      <span class="text-dark">Agendamento Dinâmico</span>
                    </li>
                    <li class="d-flex align-items-center gap-2 py-2">
                      <i class="ti ti-check text-primary"></i>
            ...
            <div class="col-sm-12 mt-2 mt-lg-0 col-lg-6" data-aos="fade-up" data-aos-delay="600"
              data-aos-duration="1000">
              <div class="card">
                <div class="card-body text-center">
                  <span class="fw-bolder text-success fs-8 d-block mb-7">Clube <h2 class="fw-semibold fs-9 mb-7">Preço
                      <span class="fs-5">sob consulta</span>
                    </h2></span>

                  <ul class="list-unstyled text-center mb-7 ps-3 fs-7">
                    <li class="d-flex align-items-center gap-2 py-2">
                      <i class="ti ti-check text-primary"></i>
                      <span class="text-dark">Perfil</span>
                    </li>
                    <li class="d-flex align-items-center gap-2 py-2">
                      <i class="ti ti-check text-primary"></i>
                      <span class="text-dark">Estatísticas Mensais</span>
                    </li>
                    <li class="d-flex align-items-center gap-2 py-2">
                      <i class="ti ti-check text-primary"></i>
                      <span class="text-dark">Gestão de Campos</span>
                    </li>
                    <li class="d-flex align-items-center gap-2 py-2">
                      <i class="ti ti-check text-primary"></i>
                      <span class="text-dark">Gestão de Reservas</span>
                    </li>
                    <li class="d-flex align-items-center gap-2 py-2">
                      <i class="ti ti-check text-primary"></i>
                      <span class="text-dark">Gestão de Equipas e Torneios</span>
                    </li>
                    <li class="d-flex align-items-center gap-2 py-2">
                      <i class="ti ti-check text-primary"></i>
                      <span class="text-dark">Disponibilização de Resultados</span>
                    </li>
                  </ul>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-12 text-center">
              <div class="lc-block mb-4 mt-3">
                <small class="text-primary fw-semibold mb-2 d-block fs-5" data-aos="fade-up" data-aos-delay="200"
                  data-aos-duration="1000">APAIXONADOS PELO DESPORTO</small>
                <h2 class="fs-13 text-center mb-4 fw-bolder" data-aos="fade-up" data-aos-delay="400"
                  data-aos-duration="1000">A <span class="text-success">Equipa</span> por trás da visão</h2>
              </div><!-- /lc-block -->
            </div>
          ...
          <div class="row pt-4" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
            <div class="col-md-4 text-center py-4">
              <div class="lc-block"><img alt="" class="rounded-circle bg-white shadow mb-3"
                  src="../../../landingpage/dist/images/img-equipa/foto_luis.png" style="height:20vh" loading="lazy">
              ...
              <div class="lc-block"><a class="text-dark text-decoration-none" href="#"> <svg
                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" width="2em" height="2em"
                    lc-helper="svg-icon" fill="currentColor">
                    <path
                      d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z">
                    </path>
                  </svg> </a>
                <a class="text-dark text-decoration-none" href="#"> <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512" width="2em" height="2em" lc-helper="svg-icon" fill="currentColor">
                    <path
                ...
                <a class="text-dark text-decoration-none" href="#"> <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512" lc-helper="svg-icon" fill="currentColor" width="2em" height="2em">
                    <path
                ...
                <a class="text-dark text-decoration-none" href="#"> <svg xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 496 512" width="2em" height="2em" lc-helper="svg-icon" fill="currentColor">
                    <path
            ...
            <div class="col-md-4 text-center py-4">
              <div class="lc-block"><img alt="" class="rounded-circle bg-white shadow mb-3"
                  src="../../../landingpage/dist/images/img-equipa/foto_pedro.png" style="height:20vh" loading="lazy">
            ...
            <div class="col-md-4 text-center py-4">
              <div class="lc-block"><img alt="" class="rounded-circle bg-white shadow mb-3 object-fit-cover"
                  src="../../../landingpage/dist/images/img-equipa/foto_mariana.png" style="height:20vh" loading="lazy">
                <h5 editable="inline" class="fs-9"><strong>Mariana Martins</strong></h5>

                <small editable="inline" class="text-secondary fs-5" style="letter-spacing:1px">PROGRAMADORA</small>
      ...
      <section class="bg-primary pt-lg-4 pt-sm-2 pb-7 pb-lg-6" id="sobrenos-courtify">
        <div class="container py-5">
          <div class="row">
            <div class="col-md-3 align-self-center justify-content-center" data-aos="fade-up" data-aos-delay="200"
              data-aos-duration="1000">
              ...
              <div class="text-center mt-2">
                <img src="dist/images/logos/logo_icone.png" width="64px">
              </div>
            </div>
              ...
              <div class="lc-block">
                <div editable="rich">
                  <p class="text-white fs-7">A Courtify é uma Plataforma Desportiva concebida para satisfazer as tuas
                    necessidades como entusiasta do desporto.<br>
                    Lançada em 2023, a Courtify é o resultado da visão e dedicação de três estudantes apaixonados por
                    programação e desporto.</p>
                </div>
              </div>
              <div class="lc-block">
                <div editable="rich">
                  <p class="text-white fs-7">A Courtify proporciona-te uma
                    <b>experiência de utilizador</b> excecional, <b>características inovadoras</b> e uma <b>vasta gama
                      de
            ...
            <div class=" col-md-3 d-flex justify-content-center align-self-center" data-aos="fade-up"
              data-aos-delay="600" data-aos-duration="1000">
              <img src="../../../landingpage/dist/images/backgrounds/bg_sobrenos.jpg"
                class="border border-2 border-white rounded" height="500px">
            </div>
          </div>
        </div>
      </section>
      <section class="py-3 py-md-5 pt-lg-7 pt-sm-3 pb-8 pb-lg-9" id="contactenos-courtify">
        <div class="col-md-12 text-center">
          ...
          <div class="lc-block mb-4 mt-3">
            <small class="text-primary fw-semibold mb-2 d-block fs-5" data-aos="fade-up" data-aos-delay="200"
              data-aos-duration="1000">AINDA TEM DÚVIDAS?</small>
                ...
                <form id="form">
                  <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                    <div class="field col-12 col-md-6">
                      <div class="">
                        <label for="fullname" class="form-label fs-5">Nome Completo <span
                    ...
                    <div class="field col-12 col-md-6">
                      <div class="">
                        <label for="reply-to" class="form-label fs-5">Email <span
                            class="text-danger ms-2">*</span></label>
                        <div class="input-group">
                          <span class="input-group-text">
                    ...
                    <div class="field">
                      <div class="col-12">
                        <label for="message" class="form-label fs-5">Mensagem<span
                            class="text-danger ms-2">*</span></label>
