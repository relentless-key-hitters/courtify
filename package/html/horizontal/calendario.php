        ...
        <nav class="navbar navbar-expand-xl navbar-light container-fluid px-0">
          ...
          <div class="d-block d-xl-none mb-2">
            <a href="./index.php" class="text-nowrap nav-link">
              <img src="../../dist/images/logos/logo_courtify.png" class="" width="180" alt="" />
            </a>
          </div>
    ...
    <div class="row">
      <div class="d-none d-md-block">
        <div class="col-lg-12" style="position: relative; margin-top: 80px;">
          ...
          <img class="img-fluid" src="../../dist/images/backgrounds/max-bohme-DRwfzyyKw1s-unsplash.jpg" style="width: 100%; max-width: 100%; height: 600px; object-fit: cover; filter: brightness(50%);">
          <div style="position: absolute; top: 20%; transform: translateY(-50%); left: 10%; text-align: center; color: white;">
        ...
        <div class="col-12 col-sm-12 col-md-9 text-center">
          <div class="card shadow">
            <div class="container pt-2">
              <h1 class="fw-semibold fs-7">Calendário</h1>
            </div>
