            ...
            <div class="tab-pane fade" id="pills-followers" role="tabpanel" aria-labelledby="pills-followers-tab" tabindex="0">
              ...
              <div id="estatisticasPadel" class="d-none">
                ...
                <div class="row">
                  ...
                  <div class="col-6 col-sm-6 col-md-3 d-flex align-items-stretch">
                  ...
                  <div class="card-body p-4">
                    ...
                    <div class="row">
                        ...
                        <div class="card w-100 position-relative overflow-hidden mb-7 mb-lg-0">
                          <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-7">
                              <div>
                                <h4 class="mb-0 fw-semibold">Performance Geral</h4>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-4 d-flex align-items-stretch">
                        <div class="card w-100 position-relative overflow-hidden mb-7 mb-lg-0">
                          <div class="card-body">
                            ...
                            <div class="d-flex align-items-end justify-content-between mt-7">
                              <div>
                                <h4 class="mb-0 fw-semibold">Distribuição % Vitórias</h4>
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="col-md-4 d-flex align-items-stretch">
                        <div class="card w-100 position-relative overflow-hidden mb-7 mb-lg-0">
                          <div class="card-body">
                            <div id="barPadel4"></div>
                            <div class="d-flex align-items-end justify-content-between mt-7">
                              <div>
                                <h4 class="mb-0 fw-semibold">Distribuição % Mvp</h4>
                              </div>
                            </div>
                          </div>
                        </div>
