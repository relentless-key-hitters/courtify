      ...
      <div class="">
        <div class="row">
          <div class="col-lg-12" style="position: relative; margin-top: 80px;">
            ...
            <img class="img-fluid" src="../../dist/images/backgrounds/tomasz-krawczyk-M2x3A8Q4JbY-unsplash.jpg"
              style="width: 100%; max-width: 100%; height: 600px; object-fit: cover; filter: brightness(50%);">
            <div
              style="position: absolute; top: 40%; transform: translateY(-50%); left: 50%; text-align: center; color: white;">
            ...
            <div class=" mt-5">
              <div class="card bg-light shadow px-3 py-3">
                <div class="d-flex justify-content-between align-items-center mb-4 mt-2">
                  <h3 class="">Confere aqui os melhores <span class="text-success fw-bold">Grupos</span> desta semana
                  </h3>
                              ...
                              <div class="card hover-img shadow position-relative">
                                ...
                                <div class="p-3 d-flex flex-column align-items-center justify-content-between mt-1">
                                  ...
                                  <div class="d-flex align-items-center mt-2">
                                    <span class="badge text-dark fs-2 rounded-4 lh-sm py-1 px-2 fw-semibold me-2"
